if __name__ == '__main__':
    ...
    for move in moves:
        ...
        start = len(final_stack[__from__]) - __count__
        end = len(final_stack[__from__])

        final_stack[__to__] += final_stack[__from__][start:end]
        final_stack[__from__] = final_stack[__from__][0:start]
